...
//     try {
//       const data = await adminService.getAdminActionLogs(0, 10); // Récupérer les 10 derniers logs
//       setLogs(data);
//     } catch (err) {
...
//       setLogs(logs); // Stocker les logs pour l'affichage
//     } catch (error) {
...
//       >
//         {/* Header */}
//         <View className="bg-slate-100 from-blue-600 to-purple-600 p-6 rounded-b-3xl mb-6">
...
//           </Text>
//           <View className="flex-row flex-wrap justify-between">
//             <TouchableOpacity className="bg-white rounded-2xl p-4 mb-4 shadow-sm border border-gray-100 w-full">
...
//               onPress={() => {
//                 // Navigation vers l'onglet logs
//                 Alert.alert('Navigation', 'Aller vers l\'onglet Logs');
//               }}
//             >
