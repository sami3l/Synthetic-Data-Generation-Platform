...
export default function FileUploadComponent({
  ...
  return (
    <View className="bg-white-800 rounded-lg p-4 mb-4">
      ...
      {selectedFile && (
        <View className="bg-white-700 p-3 rounded-lg mb-4">
      ...
      <View className="flex-row mb-4">
        <TouchableOpacity
          ...
          className={`flex-1 bg-white border border-gray-500 rounded-lg p-3 mr-2 ${
